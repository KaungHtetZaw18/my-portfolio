...
export default function ContactModal({ open, onClose }) {
  ...
  return (
    ...
    >
      ...
      {/* WRAPPER for Center + Width */}
      <div className="relative z-[81] w-full max-w-lg sm:max-w-2xl md:max-w-5xl">
        <Reveal width="100%" variant="zoom" delay={0}>
          <div
            ref={dialogRef}
            className={[
              "w-full",
              ...
              >
                ...
                <label className="text-sm font-medium">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border px-3 py-3 text-base sm:py-2.5 sm:text-sm outline-none focus:ring-2 focus:ring-neutral-300 transition-shadow"
                  />
                </label>
