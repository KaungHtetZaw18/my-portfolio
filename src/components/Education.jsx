    ...
    <section id="education" className="relative py-24">
      <div className="mx-auto max-w-6xl px-4 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <Reveal delay={200} variant="left" triggerOnce>
          ...
          <div className="space-y-10">
            {/* Education Block - Slides UP */}
            <Reveal delay={400} width="100%" variant="up" triggerOnce>
              <div>
            ...
            {/* Certifications Block - Slides UP */}
        ...
        <div className="flex justify-center lg:justify-start">
          <Reveal delay={200} width="100%" variant="right" triggerOnce>
            <img
